...
namespace OptimES
{
    ...
    public:
	/*! \brief Constructor.
	 * \param _size Number of genes (parameters) that the object contains.
	 */
	Chromosome(size_t _size);
	/*!\brief Constructor
	 * \param _val  Pointer to the values of the parameters.
	 * \param _size Number of parameters that the object contains.
	 */
	Chromosome(double* _val, size_t _size);
